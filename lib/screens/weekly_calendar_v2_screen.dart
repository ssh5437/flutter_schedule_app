...
class WeeklyCalendarV2Screen extends StatefulWidget {
  const WeeklyCalendarV2Screen({super.key});

  @override
  State<WeeklyCalendarV2Screen> createState() => WeeklyCalendarV2ScreenState();
}

class WeeklyCalendarV2ScreenState extends State<WeeklyCalendarV2Screen> {
